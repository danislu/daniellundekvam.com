$(function() {
	...
	function init() {
		...
		var g = [new Point(202, 78, 0.0, 10, "#ed9d33")];
	...
	function timeout() {
		...
		debug.innerHTML = "x:" + pointCollection.mousePos.x + " y:" + pointCollection.mousePos.y;
		...
		this.update = function() {		
			...
			for (var i = 0; i < pointsLength; i++) {
				...
				if (d < 100) {
					...
					point.targetPos.x = 0;//point.originalPos.x;
	...
	function Point(x, y, z, size, colour) {
		...
		this.draw = function() {
			...
			//ctx.fillText("x:" + this.curPos.x + " y:" + this.curPos.y, this.radius + this.curPos.x + 2, this.curPos.y);
